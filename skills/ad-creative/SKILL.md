...
For video ads, Qianchuan/Douyin creatives, or any request about why people buy, apply `marketing-psychology` before finalizing angles. Pick one primary psychological mechanism per creative: Jobs to Be Done, immediate benefit, social proof, authority, scarcity/urgency, loss aversion, contrast, reduced regret, or friction reduction. Do not stack every mechanism into one ad.
